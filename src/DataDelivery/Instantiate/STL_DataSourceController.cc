...
// $Id: STL_DataSourceController.cc,v 1.11 1998/11/06 20:12:13 cdj Exp $
//
// Revision history
//
...
//
// required for find
#  pragma define_template find< vector< DataSourceController* >::iterator ,  DataSourceController*  const >
#  pragma define_template find< vector< DataSourceController* >::iterator , const  DataSourceController*  const >
#else
// for g++ or MetroWerks
