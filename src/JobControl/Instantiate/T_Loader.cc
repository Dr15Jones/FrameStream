...
// $Id: T_Loader.cc,v 1.3 2000/12/01 20:30:54 cdj Exp $
//
// Revision history
//
// $Log: T_Loader.cc,v $
...
template class Loader< SourceFormatModule >;
template class Loader< SinkFormatModule >;

#include "DynamicLoader/Template/DLFactoryManager.cc"
template class DLFactoryManager< SourceFormatModule >;
template class DLFactoryManager< SinkFormatModule >;
