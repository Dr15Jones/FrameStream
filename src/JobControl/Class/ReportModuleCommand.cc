...
// $Id: ReportModuleCommand.cc,v 1.4 2000/06/01 17:48:44 mkl Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: ReportModuleCommand.cc,v 1.4 2000/06/01 17:48:44 mkl Exp $";
...
{
   cout << target()->printReportLevel() << endl;
...
{
   cout << target()->printAllReportLevels() << endl;
