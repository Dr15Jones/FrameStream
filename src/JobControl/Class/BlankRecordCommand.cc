...
// $Id: BlankRecordCommand.cc,v 1.12 2000/12/01 20:26:03 cdj Exp $
//
// Revision history
//
...
string( "                                                                \n" )+
string( "  emptysource oneTime <src> <rn#> <ev#> <strm1> [<strm2>..]     \n" )+
string( "  emptysource one     <src> <rn#> <ev#> <strm1> [<strm2>..]     \n" )+
string( "    define a source with name <src> with Records                \n" )+
string( "    that occur at (rn#, ev#)                                    \n" )+
string( "    You need to specify source name, run- and event- numbers,   \n" )+
string( "    and at least one stream.                                    \n" )+
string( "                                                                \n" )+
...
DABoolean
BlankRecordCommand::parseSyncValue( SyncValue& oSyncValue, int iIndex ) const
{
   const char* arg;
