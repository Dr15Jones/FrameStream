...
// $Id: SinkCommand.cc,v 1.10 2000/06/01 17:48:45 mkl Exp $
//
// Revision history
//
...
string( "//  sink edit <sink>                     edit <sink>              \n" )+
...
SinkCommand::editHandler()
{
   ...
   // different options:
   // "sink edit sinkName" --> edit sink with "sinkName"
   // correct number of args
   if( 3 == m_argc )
   {
      SinkManager::SinkName sinkName( m_argv[2] );
      SM->editSink( sinkName );
