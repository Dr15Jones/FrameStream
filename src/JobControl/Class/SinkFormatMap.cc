...
// $Id: SinkFormatMap.cc,v 1.19 2001/06/15 21:06:22 cdj Exp $
//
...
SinkFormatMap::SinkFormatMap( const string& environment )
   : FormatMap< SinkFormatModule >( "SinkFormatMap", environment ),
...
SinkFormatMap::~SinkFormatMap()
{
   ...
   FormatMap< SinkFormatModule >::unloadAll();
...
void
SinkFormatMap::initialize( const string& iName, SinkFormatModule& iFormat )
{
...
// ------------- overridden Loader< Producer > method
void
SinkFormatMap::finalize( const string& iName, SinkFormatModule& iFormat )
{
