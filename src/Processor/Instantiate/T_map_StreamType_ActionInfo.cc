...
// $Id: T_map_StreamType_ActionInfo.cc,v 1.1 1999/03/15 18:44:27 mkl Exp $
//
// Revision history
//
// $Log: T_map_StreamType_ActionInfo.cc,v $
// Revision 1.1  1999/03/15 18:44:27  mkl
...
typedef Processor::ActionInfo _map_contents_;
