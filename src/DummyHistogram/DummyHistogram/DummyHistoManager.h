...
// $Id: DummyHistoManager.h,v 1.7 2003/01/20 20:27:49 cdj Exp $
//
// Revision history
//
// $Log: DummyHistoManager.h,v $
// Revision 1.7  2003/01/20 20:27:49  cdj
...
class DummyHistoManager : public HIHistoManager
{
   ...
   public:
	 ...
	 float         iNegativeError );
      ...
      virtual void setDefaultDir( const std::string& iDirectoryName ) ;
