...
// $Id: InteractiveSourceController.cc,v 1.8 1998/09/26 19:56:21 cdj Exp $
//
// Revision history
//
			      ...
			      Stream::Type& oRecordTypeOfNextRecord)
{
   ...
   oRecordTypeOfNextRecord = Stream::kEvent;
...
{
   ProxyDeliverer* returnValue = new InteractiveProxyDeliverer;

   if( 0 == returnValue ){
      report(EMERGENCY,"DataSourceController") <<"Out of Memory"<<endl;
      assert(false);
      exit(1);
   }
