...
// $Id: NamingService.cc,v 1.2 1999/12/11 19:10:14 mkl Exp $
//
// Revision history
//
...
static const char* const kNamingServiceIdString  = "$Id: NamingService.cc,v 1.2 1999/12/11 19:10:14 mkl Exp $";
