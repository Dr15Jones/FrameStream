...
// $Id: DLSharedObject.cc,v 1.1.1.1 2000/11/30 20:51:31 cdj Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DLSharedObject.cc,v 1.1.1.1 2000/11/30 20:51:31 cdj Exp $";
