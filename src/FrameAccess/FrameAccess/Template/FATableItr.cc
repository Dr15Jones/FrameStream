...
// $Id: FATableItr.cc,v 1.11 2000/12/26 21:10:21 cdj Exp $
//
// Revision history
//
// $Log: FATableItr.cc,v $
...
template < class T >
FATableItr< T >::FATableItr( const _fatableitr_map_::const_iterator& aElement) :
	 m_element( aElement )
{
...
FATableItr< T >::FATableItr( // this one used to use default FAItem c'tor
   const _fatableitr_map_::const_iterator& aElement, int ) :
   m_element( aElement )
{
}
