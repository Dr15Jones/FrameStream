...
// $Id: FAPtrTable.cc,v 1.10 2001/01/02 22:20:33 cdj Exp $
//
// Revision history
//
// $Log: FAPtrTable.cc,v $
...
FAPtrTable< T >::eraseAll()
{
   _fatableitr_map_::iterator start( m_map.begin() ) ;
   _fatableitr_map_::iterator finished( m_map.end() ) ;
   for ( _fatableitr_map_::iterator entry( start ) ;
	 entry != finished ;
	 ++entry ) {
