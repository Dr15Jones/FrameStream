...
// $Id: HIHist1D.h,v 1.8 2003/01/17 20:34:30 cdj Exp $
//
// Revision history
//
// $Log: HIHist1D.h,v $
// Revision 1.8  2003/01/17 20:34:30  cdj
// use namespace to avoid using template math operations with non-histogram code
//
// Revision 1.7  2002/07/26 18:23:15  cdj
// made copy constructor and assignment operator visible
//
...
class HIHist1D : public HIHist
{
   ...
   protected:
      ...
      const HIHist1D& operator=( const HIHist1D& iRHS) {
	 (*static_cast<HIHist*>(this)) = iRHS;
	 m_nchannels = iRHS.m_nchannels;
	 m_lowedge = iRHS.m_lowedge;
	 m_highedge = iRHS.m_highedge;
	 m_bitsperchannel = iRHS.m_bitsperchannel;
	 return *this;
      }
