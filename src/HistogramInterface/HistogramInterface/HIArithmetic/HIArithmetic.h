...
inline
HIHistHolder<HIHist1D>
operator*( double iScale, const HIHist1D& rHist )
{
   HIHistHolder<HIHist1D> histHolder( rHist );
   histHolder.setScalar( iScale );
   return histHolder;
...
inline
HIHistHolder<HIHist2D>
operator*( double iScale, const HIHist2D& rHist )
{
   HIHistHolder<HIHist2D> histHolder( rHist );
   histHolder.setScalar( iScale );
   return histHolder;
...
inline
HIHistHolder<HIHist2D>
operator*( float iScale, const HIHist2D& rHist )
{
   HIHistHolder<HIHist2D> histHolder( rHist );
   histHolder.setScalar( iScale );
   return histHolder;
...
operator+( const HIHist2D& rHist1, 
