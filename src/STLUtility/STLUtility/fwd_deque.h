#if !defined(STLUTILITY_FWD_DEQUE_H)
#define STLUTILITY_FWD_DEQUE_H
// -*- C++ -*-
//
// Package:     STLUtility
// Module:      fwd_deque
// 
// Description: Handle the forward declaration of the STL deque
//
// Usage:
//    include this file wherever you'd normally forward declare a STL deque
//
// Author:      Simon Patton
// Created:     Fri Jul  18 12:23:45 EDT 1997
// $Id: fwd_deque.h,v 1.5 2000/12/02 20:10:01 cdj Exp $
//
// Revision history
//
// $Log: fwd_deque.h,v $
...
#if !defined(STL_DEQUE)
#  define STL_DEQUE( c ) deque< c >
#  define STL_DEQUE_ALLOC( c , a ) deque< c , a >

#if defined(NO_ALLOCATOR_IN_STL_DECLARATION_BUG)
#  undef STL_DEQUE_ALLOC
#else

#if (defined(NO_DEFAULT_ALLOCATOR_IN_STL_BUG) || defined(NO_DEFAULT_PARAMETERS_FOR_TEMPLATES_BUG))
#  undef STL_DEQUE
#  define STL_DEQUE( c ) deque< c , STL_ALLOCATOR( c ) >
