...
#  pragma define_template rb_tree<_map_key_ , std::pair< const _map_key_ ,  _map_contents_ > , select1st< std::pair< const _map_key_ ,  _map_contents_ > , _map_key_ > , _map_compare_ , allocator< _map_contents_ > >
//
...
void __distance(rb_tree<_map_key_ , std::pair< const _map_key_ ,  _map_contents_ > , select1st< std::pair< const _map_key_ ,  _map_contents_ > , _map_key_ > , _map_compare_ , allocator< _map_contents_ > >::iterator first,
		rb_tree<_map_key_ , std::pair< const _map_key_ ,  _map_contents_ > , select1st< std::pair< const _map_key_ ,  _map_contents_ > , _map_key_ > , _map_compare_ , allocator< _map_contents_ > >::iterator last, 
		unsigned long& n,
		bidirectional_iterator_tag) {
   while (first != last) { ++first; ++n; }
}

void __distance(rb_tree<_map_key_ , std::pair< const _map_key_ ,  _map_contents_ > , select1st< std::pair< const _map_key_ ,  _map_contents_ > , _map_key_ > , _map_compare_ , allocator< _map_contents_ > >::const_iterator first,
		rb_tree<_map_key_ , std::pair< const _map_key_ ,  _map_contents_ > , select1st< std::pair< const _map_key_ ,  _map_contents_ > , _map_key_ > , _map_compare_ , allocator< _map_contents_ > >::const_iterator last, 
		unsigned long& n,
		bidirectional_iterator_tag) {
   while (first != last) { ++first; ++n; }
}
