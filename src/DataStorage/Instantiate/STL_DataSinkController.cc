...
// $Id: STL_DataSinkController.cc,v 1.8 1998/11/06 20:24:47 cdj Exp $
//
// Revision history
//
...
//
// required for find
#  pragma define_template find< vector< DataSinkController* >::iterator ,  DataSinkController*  const >
#  pragma define_template find< vector< DataSinkController* >::iterator , const  DataSinkController*  const >
#else
// for g++ or MetroWerks
