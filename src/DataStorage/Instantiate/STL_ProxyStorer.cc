...
// $Id: STL_ProxyStorer.cc,v 1.6 1998/11/06 20:24:49 cdj Exp $
//
// Revision history
//
...
//
// required for find
#  pragma define_template find< vector< ProxyStorer* >::iterator ,  ProxyStorer*  const >
#  pragma define_template find< vector< ProxyStorer* >::iterator , const  ProxyStorer*  const >
#else
// for g++ or MetroWerks
