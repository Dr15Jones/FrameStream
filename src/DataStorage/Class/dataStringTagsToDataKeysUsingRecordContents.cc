...
// $Id: dataStringTagsToDataKeysUsingRecordContents.cc,v 1.1 2001/06/15 21:05:11 cdj Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: dataStringTagsToDataKeysUsingRecordContents.cc,v 1.1 2001/06/15 21:05:11 cdj Exp $";
