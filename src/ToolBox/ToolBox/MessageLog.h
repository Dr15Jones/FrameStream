...
// $Id: MessageLog.h,v 1.10 2001/09/21 20:20:39 dsr Exp $
//
// Revision history:
//
// $Log: MessageLog.h,v $
...
class MessageLog {
   ...
   // Friend classses and functions
      ...
      class msgstreambuf : public strstreambuf {
	 public:
	    virtual ~msgstreambuf() {}
	    msgstreambuf() : strstreambuf() {}
	    msgstreambuf(int initial_size) : strstreambuf(initial_size) {}
	    virtual int sync();
