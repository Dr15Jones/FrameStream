...
// $Id: TBNTupleVarNames.cc,v 1.2 1998/10/22 17:38:47 cdj Exp $
//
// Revision history
//
// $Log: TBNTupleVarNames.cc,v $
...
#include "ToolBox/TBNTupleVarNames.h"
...
static const char* const kFacilityString = "ToolBox.TBNTupleVarNames" ;
...
//
TBNTupleVarNames::TBNTupleVarNames( unsigned int iNumberOfVariables ) :
...
// TBNTupleVarNames::TBNTupleVarNames( const TBNTupleVarNames& rhs )
// {
...
TBNTupleVarNames::~TBNTupleVarNames()
{
   //delete the entries
   for( char** pIndex = m_varNames ; 
	pIndex != m_varNames + m_nVars; 
...
//
// const TBNTupleVarNames& TBNTupleVarNames::operator=( const TBNTupleVarNames& rhs )
// {
//   if( this != &rhs ) {
...
//
void
TBNTupleVarNames::addVar( unsigned int iIndex, const char* iName )
{
