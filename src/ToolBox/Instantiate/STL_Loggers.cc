...
// $Id: STL_Loggers.cc,v 1.10 1998/10/01 19:21:31 mkl Exp $
//
// Revision history
//
...
#elif ( __GNUC__ == 2 && __GNUC_MINOR__ >= 80 )   
#include "STLUtility/instantiate_multimap.h"
template class rb_tree<string, pair<string const, MessageLog::Logger*>, select1st<pair<string const, MessageLog::Logger*> >, less<string> > ;
#else
template class multimap<string, MessageLog::Logger*, less<string> > ;
template class pair<string const, MessageLog::Logger *> ; 
template class rb_tree<string, pair<const string, MessageLog::Logger*>, select1st<pair<const string, MessageLog::Logger*>, string>, less<string> > ;
