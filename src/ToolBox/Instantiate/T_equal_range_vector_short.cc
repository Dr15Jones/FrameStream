...
//
// Package:     ToolBox
// Module:      T_equal_range_vector_short
// 
// Description: instantiate equal_range(vector<short>::iterator,...);
//
// Implementation:
...
// $Id: T_equal_range_vector_short.cc,v 1.1 2000/07/12 20:42:08 cdj Exp $
//
// Revision history
//
// $Log: T_equal_range_vector_short.cc,v $
...
typedef short _equal_range_value_type_; 
