...
// $Id: ChainSourceController.h,v 1.9 1998/07/18 19:45:19 mkl Exp $
//
// Revision history
//
...
class ChainSourceController : public DataSourceController
{
   ...
   private:
      ...
      DataSourceController::SearchStatus
              peekAtRecordOfNextSource( SyncValue& oSyncValueOfNextRecord,
					Stream::Type& oRecordTypeOfNextRecord);
